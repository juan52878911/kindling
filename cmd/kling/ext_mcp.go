...
// mcpExtension es lo que kindling-mcp aporta a `kling`, todavía dentro de este
// binario. Pasa ya por el mismo camino que una extensión externa —ayuda,
// completado, gancho de `kling status`— para que el día que se mude a su propio
// binario (kling-mcp) nada de lo que ve quien usa kling cambie.
...
`,
	},
	{
		...
		Subcommands: []string{"import", "list", "ls", "refresh", "verify", "health", "heal", "link", "unlink"},
