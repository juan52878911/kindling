...
| `squeeze` | reclama lo libre del invitado, según sus estadísticas | el framework no da estadísticas del invitado: aprieta a ciegas hasta dejarle la mitad de su memoria (nunca menos de 128 MiB), espera a que la huella deje de bajar y vuelve a la línea base |
