...
| [`codificador.md`](codificador.md) | La capa 3 de la domótica: un codificador de frases (multilingual-e5-small, MIT) servido como un VON (kind `embed`), la cabeza `.jenc` en Go, su evaluación honesta, latencia y memoria, y la receta del ajuste fino con GPU | vas a tocar la capa entre JEV y el LLM, o a servir embeddings |
